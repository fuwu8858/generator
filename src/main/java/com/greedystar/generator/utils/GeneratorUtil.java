...
public class GeneratorUtil {
    ...
    public static String generateEntityProperties(List<ColumnInfo> infos) {
        ...
        for (int i = 0; i < infos.size(); i++) {
            ...
            sb.append("private ").append(TypeUtil.parseTypeFormSqlType(infos.get(i).getType())).append(" ").append(infos.get(i).getPropertyName()).append("; //").append(infos.get(i).getDesc()).append("\n");
        }
        return sb.toString();
    }
