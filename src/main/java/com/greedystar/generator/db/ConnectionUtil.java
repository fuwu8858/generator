...
public class ConnectionUtil {
    ...
    public List<ColumnInfo> getMetaData(String tableName) throws SQLException {
        ...
        while(resultSet.next()) {
            ...
            maps.put(resultSet.getString("COLUMN_NAME"),resultSet.getString("REMARKS"));
        }
        ...
        for (int i = 1; i <= metaData.getColumnCount(); i++) {
            ...
            if (metaData.getColumnName(i).equals(primaryKey)) {
                info = new ColumnInfo(metaData.getColumnName(i), metaData.getColumnType(i), true,maps.get(metaData.getColumnName(i))+"");
            } else {

                info = new ColumnInfo(metaData.getColumnName(i), metaData.getColumnType(i), false,maps.get(metaData.getColumnName(i))+"");
            }
